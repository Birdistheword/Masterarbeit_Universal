...
namespace HurricaneVR.Framework.ControllerInput
{
    public class HVRPlayerInputs : MonoBehaviour
    {
        ...
        [Range(0f, 1f)] public float TriggerGrabThreshold = .7f;
        ...
        public bool IsLeftTriggerGrabActivated;
        ...
        public bool IsRightTriggerGrabActivated;
        ...
        private void UpdateInput()
        {
            ...
            IsLeftTriggerGrabActivated = GetIsLeftTriggerGrabActivated();
            IsLeftHoldActive = GetIsLeftHoldActive();

            IsRightGrabActivated = GetIsRightGrabActivated();
            IsRightTriggerGrabActivated = GetIsRightTriggerGrabActivated();
        ...
        public bool GetTriggerGrabActivated(HVRHandSide side)
        {
            return side == HVRHandSide.Left ? IsLeftTriggerGrabActivated : IsRightTriggerGrabActivated;
        }
        ...
        public bool GetTriggerHoldActive(HVRHandSide side)
        {
            return side == HVRHandSide.Left ? IsLeftTriggerHoldActive : IsRightTriggerHoldActive;
        }
        ...
        protected virtual bool GetIsLeftTriggerGrabActivated()
        {
            return CanTriggerGrab && LeftController.TriggerButtonState.JustActivated;
        }
        ...
        protected virtual bool GetIsRightTriggerGrabActivated()
        {
            return CanTriggerGrab && RightController.TriggerButtonState.JustActivated;
        }
