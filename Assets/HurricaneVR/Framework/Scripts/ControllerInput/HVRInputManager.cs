...
namespace HurricaneVR.Framework.ControllerInput
{
    ...
    public class HVRInputManager : MonoBehaviour
    {
        ...
        private const string ReverbG2 = "WindowsMR: 0x045E/0x066A";
        ...
        private XRInputSystem GetSDK(string manufacturer, string controllerName)
        {
            ...
            {
                //using this until i discover the device name of the reverb g2
                var hmd = HMDName.ToLower();
                if (hmd.Contains(Reverb) && hmd.Contains(G2))
                {
                    //user might be using knuckles with the reverb2
