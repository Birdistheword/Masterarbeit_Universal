...
namespace HurricaneVR.Framework.Weapons
{
    ...
    public class HVRRayCastGun : HVRDamageProvider
    {
        ...
        [Header("Deprecated Sounds (Use HVRGunSounds)")]
        public AudioClip AudioFired;
        ...
        protected virtual void OnOutofAmmo()
        {
            ...
            SFXPlayer.Instance.PlaySFX(AudioEmpty, transform.position);
        }
        ...
        protected virtual void OnFired()
        {
            ...
            {
                SFXPlayer.Instance.PlaySFX(AudioFired, transform.position);
            }
        ...
        {
            var damageHandler = hit.collider.GetComponent<HVRDamageHandler>();
            if (damageHandler)
            {
