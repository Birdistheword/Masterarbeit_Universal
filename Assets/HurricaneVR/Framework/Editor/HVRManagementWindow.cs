...
namespace HurricaneVR.Editor
{
    public class HVRManagementWindow : EditorWindow
    {
        ...
        [MenuItem("Tools/HurricaneVR")]
        public static void ShowExample()
        {
            HVRManagementWindow wnd = GetWindow<HVRManagementWindow>();
            wnd.titleContent = new GUIContent("HurricaneVR");
        }
        ...
        private void SetupButtons(VisualElement root)
        {
            ...
            {
                var path = EditorUtility.OpenFolderPanel("Load poses", HVRSettings.Instance.RuntimePosesDirectory, "");
        ...
        private void AddGrabPoints(GameObject obj)
        {
            if (!obj) return;
